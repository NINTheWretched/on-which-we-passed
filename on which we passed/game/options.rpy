q## This file contains options that can be changed to customize your game.
##
...
define config.name = _("on which we passed")
...
define build.name = "onwhichwepassed"

## Mouse #######################################################################

##init python:

##define config.mouse = { "default" : [("gui/my_cursor.png", 0, 0)] }
...
define config.save_directory = "onwhichwepassed-1768916817"
...
define config.window_icon = "gui/on_which_we_passed_icon.png"
